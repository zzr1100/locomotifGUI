...
#
# Created: Wed Aug 12 21:48:22 2015
...
class Ui_Locomotif(object):
    def setupUi(self, Locomotif):
        ...
        self.t1Polygon1View = QtGui.QTextEdit(self.t1Polygon1)
...
"font: 8pt \"Courier New\";"))
        ...
        self.t1Polygon2View = QtGui.QTextEdit(self.t1Polygon2)
...
"font: 8pt \"Courier New\";"))
        ...
        self.t1GoogleMapsView.setGeometry(QtCore.QRect(0, 0, 921, 541))
        ...
        self.Konfiguration = QtGui.QDockWidget(self.tab_2)
        self.Konfiguration.setEnabled(True)
        self.Konfiguration.setGeometry(QtCore.QRect(10, 90, 661, 431))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Konfiguration.sizePolicy().hasHeightForWidth())
        self.Konfiguration.setSizePolicy(sizePolicy)
        self.Konfiguration.setStyleSheet(_fromUtf8("background-color: rgb(229, 229, 229);\n"
"border-left-color: rgb(0, 0, 0);\n"
"border-bottom-color: rgb(0, 0, 0);\n"
"border-right-color: rgb(0, 0, 0);\n"
"border-top-color: rgb(0, 0, 0);"))
        self.Konfiguration.setFloating(False)
        self.Konfiguration.setAllowedAreas(QtCore.Qt.BottomDockWidgetArea|QtCore.Qt.TopDockWidgetArea)
        self.Konfiguration.setObjectName(_fromUtf8("Konfiguration"))
        ...
        self.groupBox = QtGui.QGroupBox(self.dockWidgetContents_5)
        self.groupBox.setGeometry(QtCore.QRect(30, 100, 151, 81))
        ...
        self.editCfgDataPath = QtGui.QLineEdit(self.dockWidgetContents_5)
        self.editCfgDataPath.setGeometry(QtCore.QRect(130, 30, 411, 20))
        ...
        self.editCfgMapPath = QtGui.QLineEdit(self.dockWidgetContents_5)
        self.editCfgMapPath.setGeometry(QtCore.QRect(130, 60, 411, 20))
        ...
        self.cmdCfgStore = QtGui.QPushButton(self.dockWidgetContents_5)
        self.cmdCfgStore.setGeometry(QtCore.QRect(480, 150, 75, 23))
        self.cmdCfgStore.setObjectName(_fromUtf8("cmdCfgStore"))
        self.cmdSelCfgDataPath = QtGui.QPushButton(self.dockWidgetContents_5)
        self.cmdSelCfgDataPath.setGeometry(QtCore.QRect(550, 30, 75, 23))
        self.cmdSelCfgDataPath.setObjectName(_fromUtf8("cmdSelCfgDataPath"))
        self.cmdSelCfgMapPath = QtGui.QPushButton(self.dockWidgetContents_5)
        self.cmdSelCfgMapPath.setGeometry(QtCore.QRect(550, 60, 75, 23))
        self.cmdSelCfgMapPath.setObjectName(_fromUtf8("cmdSelCfgMapPath"))
        self.Konfiguration.setWidget(self.dockWidgetContents_5)
...
"background-color: rgb(255, 255, 255);"))
        ...
        self.cmdCreateMaps.setGeometry(QtCore.QRect(10, 250, 101, 23))
        ...
        self.cmdCreateDPolygone.setGeometry(QtCore.QRect(10, 150, 101, 23))
        ...
        self.mainDataDisplay.setCurrentIndex(1)
        self.t1Data.setCurrentIndex(2)
        ...
        QtCore.QObject.connect(self.actionEinstellungen, QtCore.SIGNAL(_fromUtf8("triggered(bool)")), self.Konfiguration.show)
        QtCore.QObject.connect(self.cmdCfgStore, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), Locomotif.doStoreCfgData)
        QtCore.QObject.connect(self.cmdSelCfgDataPath, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), Locomotif.doSelectDataPath)
        QtCore.QObject.connect(self.cmdSelCfgMapPath, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), Locomotif.doSelectMapPath)
    ...
    def retranslateUi(self, Locomotif):
        ...
        self.t1Data.setTabText(self.t1Data.indexOf(self.t1FileData), _translate("Locomotif", "Datei", None))
        self.t1Data.setTabText(self.t1Data.indexOf(self.t1DataFrame), _translate("Locomotif", "Geladene Daten", None))
        ...
        self.mainDataDisplay.setTabText(self.mainDataDisplay.indexOf(self.tab_1), _translate("Locomotif", "Datensatz 1", None))
        self.Konfiguration.setWindowTitle(_translate("Locomotif", "Einstellungen", None))
        self.label_5.setText(_translate("Locomotif", "Pfad zu Datendateien:", None))
        self.label_6.setText(_translate("Locomotif", "Pfad zu Map-Dateien:", None))
        self.groupBox.setTitle(_translate("Locomotif", "Kartengröße", None))
        self.label_7.setText(_translate("Locomotif", "Breite:", None))
        self.label_8.setText(_translate("Locomotif", "Höhe:", None))
        self.cmdCfgStore.setText(_translate("Locomotif", "Speichern", None))
        self.cmdSelCfgDataPath.setText(_translate("Locomotif", "Auswahl", None))
        self.cmdSelCfgMapPath.setText(_translate("Locomotif", "Auswahl", None))
        self.mainDataDisplay.setTabText(self.mainDataDisplay.indexOf(self.tab_2), _translate("Locomotif", "Datensatz 2", None))
        self.menuFile.setTitle(_translate("Locomotif", "Datei", None))
        self.menuView.setTitle(_translate("Locomotif", "Bearbeiten", None))
        ...
        self.QuickStatus.setWindowTitle(_translate("Locomotif", "Auswertung", None))
        ...
        self.cmdCreateDPolygone.setText(_translate("Locomotif", "D-Polygone ber.", None))
        ...
        self.actionHilfe.setText(_translate("Locomotif", "Hilfe", None))
        self.actionEinstellungen.setText(_translate("Locomotif", "Einstellungen", None))
        self.actionInfo.setText(_translate("Locomotif", "Info...", None))
        self.actionEdit.setText(_translate("Locomotif", "Aktueller Datensatz", None))
        self.actionCommands.setText(_translate("Locomotif", "Quick Command Box", None))
        self.actionLoadDataFile.setText(_translate("Locomotif", "Datensatz auswählen...", None))
